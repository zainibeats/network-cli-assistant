...
def create_generic_error(
    error_message: str, error_type: str = "generic_error", **additional_fields
) -> dict:
    """
    ...
    """
    error_response = {"success": False, "error": error_message, "error_type": error_type}
...
def handle_unexpected_error(
    operation: str, exception: Exception, context: Dict[str, Any] = None
) -> dict:
    """
