...
- Always signal me when it's time to agentically work on your own (i.e. spin up sub-agents, write/use skills, search online, etc without human interaction).
...
- Broad, risky, or destructive operations should clarify or confirm scope first unless the assistant can infer safe local context.
